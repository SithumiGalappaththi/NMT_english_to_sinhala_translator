...
eng_max_length = 47  # Change if different in your training
...
if st.button("Translate"):
    if input_text.strip():
        ...
        st.markdown(
            f'<span style="color:yellow;">Confidence:</span> <span style="color:white; font-weight:bold;">{sin_conf:.2f}%</span>',
        ...
        st.markdown(
            f'<span style="color:yellow;">Confidence:</span> <span style="color:white; font-weight:bold;">{sing_conf:.2f}%</span>',
            unsafe_allow_html=True
        )
